    ...
    <head>
        ...
        <script>
            window.onload = function() {
                window.location.href = "https://dlocal.github.io/mobile-checkout-sdk-ios/${version}/documentation/dlmobilecheckoutsdk";
            };
        </script>
    </head>
    <body>
        <h1>Redirecting...</h1>
        <p>If you are not redirected automatically, <a href="https://dlocal.github.io/mobile-checkout-sdk-ios/${version}/documentation/dlmobilecheckoutsdk">click here</a>.</p>
    </body>
    </html>`;
